...
class Authorization(QtWidgets.QWidget):
    ...
    def onPushButtonEnterClicked(self):
        try:
            ...
            self.ui1.lineEdit_Surname.setText("")
            QtWidgets.QMessageBox.warning(self, "Ошибка!", "Введите Вашу фамилию!")
...
class Circulation_Form(QtWidgets.QWidget):
    ...
    def initUi(self):
        ...
        self.ui.lineEdit.editingFinished.connect(self.selectBook)
        self.ui.lineEdit_2.editingFinished.connect(self.selectBook)
